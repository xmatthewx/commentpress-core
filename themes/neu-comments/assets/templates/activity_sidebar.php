...
// @neu: let's always show these. remove the header. no need to collapse. 
// @neu: doc specific comment in order by time. commentpress can also show site wide comments, which are irrelevant to us
...
?><h3 style="display:none;" class="activity_heading"><?php echo $page_comments_title; ?></h3>
<div style="display:block;" class="paragraph_wrapper page_comments_output">
...
// @neu: this shows site wide comments
// @neu: not relevant for our use
if ( $_all_comments_output != '' ) {

// allow plugins to add their own activity heading here
do_action( 'commentpress_bp_activity_sidebar_before_all_comments' );

?><h3 style="display:none" class="activity_heading"><?php echo $_all_comments_title; ?></h3>

<div style="display:none" class="paragraph_wrapper all_comments_output">

<?php 
    // echo $_all_comments_output; 
    ?>
